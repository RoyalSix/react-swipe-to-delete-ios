...
class SwipeToDelete extends React.Component {
  ...
  onMouseMove = (e) => {
    ...
    this.setState({
      translate:
        cursorPosition(e) - this.startTouchPosition + this.initTranslate,
    });
  };
  ...
  onMouseUp = () => {
    ...
    const deleteWithoutConfirm =
      -this.state.translate >= this.deleteWithoutConfirmThreshold;
    ...
    return (
      ...
      >
        <Delete
          ...
          buttonMarginLeft={
            shiftDelete
              ? this.containerWidth + translate
              : this.containerWidth - deleteWidth
          }
          {...cssParams}
        >
